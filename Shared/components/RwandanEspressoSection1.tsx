    ...
    <View style={styles.cardParent}>
      <View style={[styles.card, styles.bg1Position]}>
        ...
        <View style={styles.text}>
          ...
          <Text style={[styles.pm1, styles.pm1Layout]}>Status: COMPLETE</Text>
          <Text style={[styles.pm2, styles.pm2Typo]}>5/5</Text>
...
export default RwandanEspressoSection1;
