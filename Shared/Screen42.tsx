...
export const Screen42 = () => {
  return (
    <View style={styles.screen42}>
...
`}</Text>
      ...
      />
      <Image
        style={styles.screen42Child}
        contentFit="cover"
        source={require("../assets/ellipse-24.png")}
      />
      <Image
        style={styles.screen42Item}
        contentFit="cover"
        source={require("../assets/ellipse-23.png")}
      />
      <Text
        style={[styles.pm, styles.pmTypo]}
      >{`Planting Stage Complete `}</Text>
      <Image
        style={styles.screen42Inner}
        contentFit="cover"
      ...
      <View style={styles.storyParent}>
        ...
        <Text style={[styles.checkAvailability, styles.textPosition]}>1/5</Text>
      </View>
    </View>
  );
};
