...
export const ShoppingCart = ({ color = "#7D523F", className }: Props): JSX.Element => {
  return (
    <svg
    ...
    >
      <g className="g" clipPath="url(#clip0_126_369)">
        <path
          className="path-3"
          clipRule="evenodd"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_126_369">
