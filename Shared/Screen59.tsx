...
export const Screen59 = () => {
  return (
    <View style={styles.screen59}>
...
`}</Text>
      ...
      />
      <Image
        style={styles.screen59Child}
        contentFit="cover"
        source={require("../assets/ellipse-24.png")}
      />
      <Image
        style={styles.screen59Item}
        contentFit="cover"
        source={require("../assets/ellipse-232.png")}
      />
      <Text style={[styles.pm, styles.pmTypo]}>{`Drying Stage Complete `}</Text>
      <Image
        style={styles.screen59Inner}
        contentFit="cover"
      ...
      <View style={styles.storyParent}>
        ...
        <Text style={[styles.checkAvailability, styles.textPosition]}>4/5</Text>
      </View>
    </View>
  );
};
