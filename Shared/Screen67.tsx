...
export const Screen67 = () => {
  return (
    <View style={styles.screen67}>
...
`}</Text>
      ...
      />
      <Image
        style={styles.screen67Child}
        contentFit="cover"
        source={require("../assets/ellipse-24.png")}
      />
      <Image
        style={styles.screen67Item}
        contentFit="cover"
        source={require("../assets/ellipse-232.png")}
      />
      <Text style={[styles.pm, styles.pmTypo]}>{`Milling Stage
Complete`}</Text>
      <Image
        style={styles.screen67Inner}
        contentFit="cover"
      ...
      <View style={styles.storyParent}>
        ...
        <Text style={[styles.checkAvailability, styles.textPosition]}>5/5</Text>
      </View>
    </View>
  );
};
