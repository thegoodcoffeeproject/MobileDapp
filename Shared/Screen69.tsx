...
import RwandanEspressoSection1 from "../components/RwandanEspressoSection1";
import { Color, FontFamily, Border, FontSize } from "../GlobalStyles";

export const Screen69 = () => {
  return (
    <View style={styles.screen69}>
      <Image
      ...
      <Container group1={require("../assets/group-1.png")} />
