      ...
      <View style={styles.header}>
        ...
        {phantomWalletPublicKey ? (
          <>
            ...
            <TouchableOpacity style={styles.imageHolder} onPress={() => navigation.navigate('App1b', { page1Input: input, signAndSendTransaction: signAndSendTransaction, phantomWalletPublicKey: phantomWalletPublicKey, sharedSecret: sharedSecret })}>
...
Hey ${phantomWalletPublicKey.toString()}`}</Text>
      ...
      <Button
        title="Next"
        onPress={() => navigation.navigate('App1d', { page1Input: input, signAndSendTransaction: signAndSendTransaction, phantomWalletPublicKey: phantomWalletPublicKey, sharedSecret: sharedSecret })}
      />
    </View>
      {submitting && (
        <ActivityIndicator
