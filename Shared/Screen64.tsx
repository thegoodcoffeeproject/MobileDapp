...
import MillingProcessContainer1 from "../components/MillingProcessContainer1";
import { Color, FontFamily, FontSize, Border } from "../GlobalStyles";

export const Screen64 = () => {
  return (
    <View style={styles.screen64}>
      <View style={[styles.bg, styles.bgPosition]}>
        <View style={[styles.topBg, styles.topBgPosition]} />
      </View>
      <ContainerForm cHECKAVAILABILITY="05" />
      <Text style={[styles.text, styles.textTypo]}>{`MILLING STAGE `}</Text>
      <MillingProcessContainer1 />
      <View style={[styles.imageParent, styles.buttonPosition]}>
