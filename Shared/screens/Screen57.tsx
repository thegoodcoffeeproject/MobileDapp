...
export const Screen57 = () => {
  return (
    <View style={styles.screen57}>
      ...
      <Text style={[styles.freeWifi, styles.freeWifiTypo]}>
        Nyungwe, Rwanda
      </Text>
      <Text style={[styles.tryCopenhagen, styles.text1Typo]}>{`LOCATION
`}</Text>
      <Image
      ...
      <View style={styles.groupParent}>
        ...
        <View style={[styles.groupView, styles.groupLayout]}>
          <View style={styles.bg2Position}>
            ...
            <View style={[styles.likeGroup, styles.likePosition]}>
              ...
              <View style={[styles.doorsIcon, styles.doorsIconPosition]}>
                <View style={styles.bg2Position} />
              </View>
            </View>
          </View>
        ...
        <View style={[styles.groupView, styles.groupLayout]}>
          ...
          <View style={[styles.likeContainer, styles.likePosition]}>
            ...
            <Image
              style={[styles.musicAndSoundPlayerplay, styles.doorsIconPosition]}
              contentFit="cover"
