...
export const Screen54 = () => {
  return (
    <View style={styles.screen54}>
...
`}</Text>
      ...
      />
      <Image
        style={styles.screen54Child}
        contentFit="cover"
        source={require("../assets/ellipse-24.png")}
      />
      <Image
        style={styles.screen54Item}
        contentFit="cover"
        source={require("../assets/ellipse-232.png")}
      />
      <Text
        style={[styles.pm, styles.pmTypo]}
      >{`Processing Stage Complete `}</Text>
      <Image
        style={styles.screen54Inner}
        contentFit="cover"
      ...
      <View style={styles.storyParent}>
        ...
        <Text style={[styles.checkAvailability, styles.textPosition]}>3/5</Text>
      </View>
    </View>
  );
};
