...
import UploadsContainer1 from "../components/UploadsContainer1";
import PlantingStageSection from "../components/PlantingStageSection";
import { Color, FontFamily, Border, FontSize } from "../GlobalStyles";

export const Screen43 = () => {
  return (
    <View style={styles.screen43}>
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/header4.png")}
      />
      <Image
