...
import HarvestStageSection from "../components/HarvestStageSection";
import { Color, FontFamily, Border, FontSize } from "../GlobalStyles";

export const Screen48 = () => {
  return (
    <View style={styles.screen48}>
      ...
      />
      <Image
        style={styles.screen48Child}
        contentFit="cover"
        source={require("../assets/ellipse-24.png")}
      />
      <FormContainer1
        image42={require("../assets/image-422.png")}
        image43={require("../assets/image-431.png")}
      />
